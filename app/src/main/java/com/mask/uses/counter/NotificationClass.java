...
class NotificationClass {
    ...
    static class Alarm {
        ...
        Alarm(Context context) {
            ...
            BroadcastPending = PendingIntent.getBroadcast(Alarm.context,999,BroacastIntent,PendingIntent.FLAG_UPDATE_CURRENT);
        }
        ...
        static void setAlarm() {
            ...
            alarmMgr.setRepeating(AlarmManager.RTC_WAKEUP, calendar.getTimeInMillis(),
                    AlarmManager.INTERVAL_DAY, BroadcastPending);
        }
